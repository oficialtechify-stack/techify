...
void main() {
  ...
  if (u_cursorPresence > 0.001 && u_cursorEffect > 3.5)
    col += (vec3(0.12) + col * 0.08) * cursorMask * u_cursorStrength;
  if (u_grain > 0.0001)
    col += (grainHash(
...
// Techify Site Palette: Deep black/emerald/dark-green background with subtle lime/emerald highlights
const UNIFORMS = {
  colors: [
    [0.012, 0.016, 0.012], // #030403 Very dark base
    [0.035, 0.075, 0.018], // #091304 Dark forest green
    [0.075, 0.180, 0.035], // #132e09 Deep emerald/lime green
    [0.180, 0.360, 0.070], // #2e5c12 Techify dark green accent
    [0.050, 0.110, 0.025], // #0d1c06 Mid dark green
    [0.015, 0.035, 0.010], // #040903 Deep background shadow
    [0.120, 0.250, 0.050], // #1f400d Muted lime highlight
    [0.020, 0.040, 0.015]  // #050a04 Base tint
  ...
  brightness: -0.01,
  saturation: 1.35,
  hue: 0.0, // Hue 0 keeps the exact green palette specified above
  vignette: 0.45,
  blur: 0.005,
  grain: 0.020,
  seed: 8379.0,
